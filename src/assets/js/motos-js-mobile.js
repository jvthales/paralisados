...
vCImg = function(){
	...
	$('head').append('<style type="text/css">.b-full-c-bf{display:block;position:absolute;width:100%;height:100%;top:0px;left:0px;text-align:center;}.c-cont{margin:' + mTop + ' auto 0px;display:table;}.f-b{float:left;font-weight:700;font-size:' + fontBig + 'px;font-family:"Source Sans Pro",sans-serif;line-height:' + fontBig + 'px;color:#fff;}.f-s{float:left;font-weight:300;font-size:' + fontSmall + 'px;font-family:"Source Sans Pro",sans-serif;line-height:' + lineS + 'px;color:#fff;margin-right:2px;}</style>');
